...
namespace DoctorSYS
{
    public partial class frmAnalyseRevenue : Form
    {
        ...
        private void cboTime_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataSet ds = Appointment.getYearlyAnalysis(cboTime.Text.Substring(2,2));
           ...
           for (int i = 0; i < 12; i++)
            ...
            chtAnalyseRevenue.Titles.Clear();
            chtAnalyseRevenue.Titles.Add("Yearly Revenue for " + cboTime.Text);
            chtAnalyseRevenue.ChartAreas[0].AxisX.Interval = 1;
            chtAnalyseRevenue.ChartAreas[0].AxisX.MajorGrid.LineWidth = 0;
            chtAnalyseRevenue.ChartAreas[0].AxisY.MajorGrid.LineWidth = 0;
            chtAnalyseRevenue.Series[0].LegendText = "Income in €";
            chtAnalyseRevenue.Series[0].Points.DataBindXY(Months, Amounts);
            chtAnalyseRevenue.ChartAreas["ChartArea1"].AxisX.LabelStyle.Format = "C";
            chtAnalyseRevenue.Series[0].Label = "#VALY";
            chtAnalyseRevenue.Visible = true;       
